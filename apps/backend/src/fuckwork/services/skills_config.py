...
SKILLS_BY_INDUSTRY = {
    ...
    "legal": {
        ...
        "certifications": ["bar admission", "jd", "paralegal certificate", "notary public"],
    },
    # ==================== DESIGN & CREATIVE ====================
    "design": {
        "tools": [
    ...
    "construction": {
        ...
        "certifications": ["pmp", "pe", "leed", "osha 30", "osha 10", "cpm"],
    },
    # ==================== HOSPITALITY & TRAVEL ====================
    "hospitality": {
        "tools": [
    ...
    "government": {
        ...
        "clearances": ["security clearance", "public trust", "secret", "top secret", "ts/sci"],
    },
    # ==================== NON-PROFIT ====================
    "nonprofit": {
        "tools": [
    ...
    "transportation": {
        ...
        "certifications": ["cdl", "hazmat", "twic", "dot medical"],
    },
}
