...
def analyze_jd_patterns(jobs: list):
    ...
    categories = {
        ...
        'Vague/Buzzwords': ['competitive_salary', 'fast_paced', 'self_starter', 'team_player', 'dynamic'],
        'Benefits (Positive)': ['has_salary_range', 'has_401k', 'has_health', 'has_equity', 'has_pto'],
        'Quality (Positive)': ['has_responsibilities', 'has_requirements', 'has_about_us', 'has_interview_process'],
        'Red Flags': ['contact_gmail', 'contact_yahoo', 'unpaid', 'commission_only', 'mlm_patterns'],
...
def analyze_company_patterns(jobs: list):
    ...
    staffing_companies = [
        'apex systems', 'kforce', 'insight global', 'robert half',
        'teksystems', 'randstad', 'adecco', 'manpowergroup',
        'kelly services', 'hays', 'aerotek', 'modis', 'accenture',
        'infosys', 'tata', 'cognizant', 'wipro', 'hcl',
        'deloitte', 'ey', 'kpmg', 'pwc', 'jobot', 'cybercoders'
    ]
