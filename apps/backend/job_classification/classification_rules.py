...
CATEGORY_KEYWORDS_PRIORITIZED: List[Tuple[str, List[str], int]] = [
    ...
    ("restaurant_assistant_manager", [
        "restaurant assistant manager", "restaurant assistant general manager",
        "restaurant agm"
    ], 1),
    ...
    ("retail_shift_manager", [
        "shift manager", "shift lead", "shift supervisor"
    ], 1),
    
    ("sales_retail", [
        "retail sales associate", "sales associate",
        "retail associate", "sales representative retail"
    ], 1),
    ...
    ("manufacturing_supervisor", [
        "production supervisor", "production lead",
    ...
    # Construction
    ("construction_pm", [
        "construction project manager", "construction pm",
        "construction project management"
    ], 1),
    
    ("construction_estimator", [
        "construction estimator", "estimator construction",
    ...
    ("healthcare_nursing", [
        "registered nurse", " rn ", " rn,", " rn-", "rn)", "(rn",
        "nurse practitioner", " np ", " np,", " np-",
        "licensed practical nurse", " lpn ", " lpn,",
        "clinical nurse", "staff nurse", "charge nurse",
        "nursing supervisor"
    ], 1),
    
    # Healthcare Physician
    ("healthcare_physician", [
        "physician", " md ", " do ", "m.d.", "d.o.",
        "medical doctor", "surgeon", "doctor ",
        "cardiologist", "radiologist", "anesthesiologist",
        "locum physician"
    ], 1),
    ...
    ("operations_coordinator", [
        ...
        "logistics coordinator", "operations coordinator"
    ], 1),
    ...
    ("ai_research", [
        "ai researcher", "research scientist ai",
        "applied scientist"
    ], 2),
    ...
    ("finance_accounting", [
        "accountant", " cpa ", "senior accountant",
    ...
    ("operations_warehouse", [
        ...
        "warehouse coordinator", "logistics manager",
        "shipping manager", "receiving manager"
    ], 4),
    ...
    ("legal_attorney", [
        ...
        "legal counsel", "associate attorney"
    ], 6),
...
INDUSTRY_KEYWORDS: Dict[str, List[str]] = {
    ...
    "edtech": [
        "edtech", "learning platform", "online education",
        "training platform"
    ],
...
def find_category_by_keywords(title: str, description: str = "", job_function: str = "") -> str:
    ...
    non_tech_indicators = [
        "groundskeeper", "janitor", "cleaner", "landscaping", "gardener",
        "custodian", "housekeeper", "maintenance worker",
        "driver", "delivery driver", "truck driver", "forklift",
        "cashier", "stocker", "bagger",
        "cook", "chef", "kitchen", "line cook", "prep cook",
        "bartender", "server", "waiter", "waitress",
...
def find_industry_by_keywords(company_industry: str = "", company_name: str = "", job_category: str = "") -> str:
    """
